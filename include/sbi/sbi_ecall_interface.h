...
#define SBI_EXT_OPTEE				0x544545
/* SBI function IDs for OP-TEE extension */
#define SBI_EXT_OPTEE_RETURN_INIT_DONE		TEEECALL_OPTEED_RETURN_ENTRY_DONE
#define SBI_EXT_OPTEE_RETURN_ON_DONE		TEEECALL_OPTEED_RETURN_ON_DONE
#define SBI_EXT_OPTEE_RETURN_CALL_DONE		TEEECALL_OPTEED_RETURN_CALL_DONE
#define SBI_EXT_OPTEE_RETURN_INTR_DONE		TEEECALL_OPTEED_RETURN_FIQ_DONE
