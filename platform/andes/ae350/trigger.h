...
int trigger_set_mcontrol(uintptr_t, uintptr_t, uintptr_t, uintptr_t);
int trigger_set_icount(uintptr_t, uintptr_t, uintptr_t, uintptr_t);
int trigger_set_itrigger(uintptr_t, uintptr_t, uintptr_t, uintptr_t);
int trigger_set_etrigger(uintptr_t, uintptr_t, uintptr_t, uintptr_t);
